...
%prep
%setup -q -n smmap-3.0.5
cd %{_builddir}/smmap-3.0.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611429650
...
cp %{_builddir}/smmap-3.0.5/LICENSE %{buildroot}/usr/share/package-licenses/smmap/62b7f6262d13a59f19d9e458820dd16f5bd99358
